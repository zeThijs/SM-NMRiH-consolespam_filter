...
*	Name	:	[nmrih] Console Spam Patches
*	Author	:	Thijs|RogueGarlicBread, SilverShot
...
#define GAMEDATA			"nmrih_console_spam"
...
{
	CreateConVar("nmrih_console_spam_version", PLUGIN_VERSION, "Console Spam Patches version.", FCVAR_NOTIFY|FCVAR_DONTRECORD);

	char sPath[PLATFORM_MAX_PATH];
	BuildPath(Path_SM, sPath, sizeof(sPath), "gamedata/%s.txt", GAMEDATA);
	if( FileExists(sPath) == false ) SetFailState("\n==========\nMissing required file: \"%s\".\nRead installation instructions again.\n==========", sPath);

	Handle hGameData = LoadGameConfigFile("nmrih_console_spam");
